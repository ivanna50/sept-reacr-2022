...
const App = () => {
    ...
    const createCat=()=>{
        dispatch ({type:'ADD_CAT', payload:catInt.value})
        catInt.current.value=''
    };


    const createDog=()=>{
        dispatch ({type:'ADD_DOG', payload:dogInt.value})
        dogInt.current.value=''
    };
